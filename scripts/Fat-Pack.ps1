...
param(
    ...
    # Optional: The desired name of the temporary .csproj used to pack the resulting NuGet package. Defaults to the name of the input with a suffixed .autogenerated, e.g. Test.csproj -> Test.autogenerated.csproj
    [string] $outputFileName,
    # Optional: Additional arguments to pass to dotnet pack
    [string] $dotnetPackArgs,
